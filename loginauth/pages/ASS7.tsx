...
useEffect(() => {
    const fetchQuestions = async () => {
        const questionsRef = ref(database, "AssessmentContent/day7/Assessment/questions");
...
const handleViolationExit = () => {
    ...
    const handleNextQuestion = () => {
        ...
        if (selectedOption) {
            ...
            set(ref(database, `responses/${userId}/day7/${currentQuestionIndex}`), {
            ...
            set(ref(database, `responses/${userId}/day7/${currentQuestionIndex}`), matchedPairs)
    ...
    //     set(ref(database, `users/${userId}/progress/Day7/Assessment`), true);
    ...
    // };
                     ...
                     const finishQuiz = async () => {
                         ...
                         const userId = user.uid;
                         const day = "Day7"; // Dynamically set this based on the quiz day
                         router.push("/dashboard");
                         ...
                         try {
                             ...
                             const responsesRef = ref(database, `responses/${userId}/day7`);
    ...
    <div className="modal-overlay">
        <div className="modal">
            ...
            <div className="Test-Section">
                ...
                <div>
                    <h1 className="online-test-title">Detailed Assessment</h1>
                </div>
