...
const OnlineTest = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            const questionsRef = ref(database, "AssessmentContent/day4/Assessment1/questions");
    ...
    const handleNextQuestion = () => {
        ...
        if (selectedOption) {
            ...
            set(ref(database, `responses/${userId}/day4/Assessment1/${currentQuestionIndex}`), {
    ...
    return (
        <div className="Demo" onContextMenu={(e) => e.preventDefault()}>
            ...
            <div className="Test-Section">
                ...
                <div>
                    <h1 className="online-test-title">The Dawn Of GUI Agent Assessment</h1>
                </div>
