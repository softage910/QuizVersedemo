...
export default function FirstTopic() {
    return (
        <>
            <h2 className="h2">Objective : Understanding The Importance Of Data In Model Training</h2>

            <h2 className="h2"><strong>Data in the context of AI model training</strong></h2>
            <p>
