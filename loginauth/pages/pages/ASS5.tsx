...
const OnlineTest = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            const questionsRef = ref(database, "AssessmentContent/day4/Assessment3/questions");
    ...
    const handleNextQuestion = () => {
        ...
        if (selectedOption) {
            ...
            set(ref(database, `responses/${userId}/day4/Assessment3/${currentQuestionIndex}`), {
            ...
            set(ref(database, `responses/${userId}/day4/Assessment3/${currentQuestionIndex}`), matchedPairs)
    ...
    //     set(ref(database, `users/${userId}/progress/Day4/Assessment3`), true);
    ...
    //          await set(ref(database, `users/${userId}/progress/${day}/Assessment 3`), true);
    ...
    //          const responsesRef = ref(database, `responses/${userId}/day4/Assessment3`);
    ...
    //              email: userDetails.email,
    //              EmpCode: userDetails.uid,
    //              Day: "Day4 - Work Arena Assessment",
    ...
    return (
        <div className="Demo" onContextMenu={(e) => e.preventDefault()}>
            ...
            <div className="Test-Section">
                ...
                <div>
                    <h1 className="online-test-title">Work Arena Assessment</h1>
                </div>
                                ...
                                {currentQuestionIndex < questions.length - 1 ? (
                                    ...
                                    <div className="nav-buttons">
                                        <button
                                            className="nav-btn"
                                            onClick={finishQuiz} 
                                            disabled={!isNextEnabled && !selectedOption} 
                                        >
                                            Finish
                                        </button>
                                    </div>
